...
<div id="carouselExampleCaptions" class="carousel slide carousel-fade homepage" data-bs-ride="carousel" data-bs-interval="3000">
  ...
  <?php foreach($data['latest_blogs'] as $index => $blg): ?>
    <div class="carousel-item <?= $index == 0 ? 'active' : '' ?>">
      ...
      ?>
      <div class="carousel-caption d-block"> <!-- Title is now always visible, even on mobile -->
